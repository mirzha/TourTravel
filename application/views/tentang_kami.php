		    ...
		    <!-- Collect the nav links, forms, and other content for toggling -->
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="active"><a href="<?php echo site_url('tentang') ?>">Tentang Kami</a></li>
...
<!-- Who we are -->
			...
			<div class="row">
				...
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
					<div class="who">
						<img src="<?php echo base_url();?>assets/images/masuntung.jpg" alt="" class="img-responsive who-img">
						<center><p>
							Mas Untung
							<Br>
							Leader
				...
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
					<div class="who">
						<img src="<?php echo base_url();?>assets/images/mascarduz.jpg" alt="" class="img-responsive who-img">
						<center><p>
							Mas Carduz
							<br>
							Senior Leader
				...
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
					<div class="who">
						<img src="<?php echo base_url();?>assets/images/mashadid.jpg" alt="" class="img-responsive who-img">
						<center><p>
							Mas Hadid
							<br>
