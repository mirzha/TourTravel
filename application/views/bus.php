		...
		<nav class="navbar navbar-default">
			...
			<div class="row">
				...
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					<div class="who">
						<img src="<?php echo base_url();?>assets/images/busbesar.png" alt="" height=125 width=200>
						<center><p>
							Bus Besar
						</p></center>
					</div>
				...
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					<div class="who">
						<img src="<?php echo base_url();?>assets/images/bussedang.png" alt="" height=125 width=200>
						<center><p>
							Bus Sedang
						</p></center>
					</div>
				...
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					<div class="who">
						<img src="<?php echo base_url();?>assets/images/elfbesar.png" alt="" class="img-responsive who-img">
						<center><p>
							Elf Besar
						</p></center>
				...
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					<div class="who">
						<img src="<?php echo base_url();?>assets/images/elfsedang.jpg" alt="" class="img-responsive who-img">
						<center><p>
							Elf Sedang
						</p></center>
