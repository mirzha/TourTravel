...
<!-- Who we are -->
			...
			<div class="row">
				...
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					<div class="who">
						<img src="<?php echo base_url();?>assets/images/malioboro.jpg" alt="" class="img-responsive who-img">
						<center><p>
							Jogja Trip
						</p></center>
					</div>
				...
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					<div class="who">
						<img src="<?php echo base_url();?>assets/images/bali.jpg" alt="" class="img-responsive who-img">
						<center><p>
							Bali Trip
						</p></center>
				...
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					<div class="who">
						<img src="<?php echo base_url();?>assets/images/bromo.jpg" alt="" class="img-responsive who-img">
						<center><p>
							Gunung Bromo
						</p></center>
